...
for ctr in range(50):
    ...
    for m in trackname:
        if m.isalnum():
            tracknam += m
    outstr = 'C:\\Users\\mysti\\Coding\\Pystutter\\EthnoAtmos'  + str(ctr) + tracknam + '.wav'
    print("")
    ...
    for y in range(trlen):
        ...
        for ctr in range(slctot):
            ...
            try:
                ...
                oufil = "C:\\Users\\mysti\\Coding\\PyStutter\\AtmosOut\\Stutterout_" + trnam[y] + "_" + str(tim) + ".wav"
...
print("Your stutter file(s) can be found in the AtmosOut folder.")

print("")

print("Full Sounds Preparation Process Over.")
